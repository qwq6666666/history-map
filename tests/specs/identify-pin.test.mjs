...
test('點擊彈窗內「🗑️ 清除標記」按鈕會真正清除 Pin，之後點地圖才會建立新 Pin（狀態二 -> 狀態三 -> 狀態一）', () => {
  const clearBtn = identifyPopupBody.querySelector('.identify-clear-btn');
  assertTrue(!!clearBtn, '前置條件：Popup 內應該要有清除標記按鈕');
